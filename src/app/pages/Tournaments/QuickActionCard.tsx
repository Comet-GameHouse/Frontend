    ...
    >
      <div className="flex flex-col h-full">
        <div className="flex items-start justify-between mb-3 sm:mb-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-green-500 to-cyan-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-300 flex-shrink-0">
            <FontAwesomeIcon
              icon={action.icon}
        ...
        <div className="flex items-center text-green-400 text-xs sm:text-sm font-medium mt-auto">
          Explore
          <FontAwesomeIcon
            icon="arrow-right"
