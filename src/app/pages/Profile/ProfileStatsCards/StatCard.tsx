...
export const StatCard = ({ card, index }: StatCardProps) => {
  return (
    <div
      className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/30 hover:border-blue-500/30 transition-all duration-300 group"
      data-aos="zoom-in"
      data-aos-duration="400"
      data-aos-delay={index * 100}
    >
      <div className="flex items-center justify-between mb-3">
        <div className={`w-10 h-10 bg-gradient-to-r ${card.color} rounded-lg flex items-center justify-center shadow-lg`}>
          <FontAwesomeIcon
