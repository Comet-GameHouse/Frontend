            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-${service.color}-500/20 border border-${service.color}-500/30 flex items-center justify-center`}
                  >
                    <FontAwesomeIcon
                      icon={service.icon}
              ...
              <div className="flex items-center justify-between">
                <div
                  className={`inline-flex items-center gap-2 px-2 py-1 rounded-full bg-${statusConfig.color}-500/20 border border-${statusConfig.color}-500/30`}
                >
                  <FontAwesomeIcon
                    icon={statusConfig.icon as IconProp}
                    className={`text-${statusConfig.color}-400 text-xs`}
                  />
                  <span
                    className={`text-${statusConfig.color}-400 text-xs font-semibold`}
                  >
                    {statusConfig.label}
                  </span>
                </div>
