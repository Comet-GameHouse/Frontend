...
export const termsSections: TermsSection[] = [
  ...
  {
    id: 'virtual-goods',
    title: 'Virtual Goods & Currency',
    icon: 'coins',
    content: [
      'All virtual currency ("Coins") and items purchased are licensed, not sold, to you.',
  ...
  },
  {
    ...
    icon: 'balance-scale',
    content: [
      'To the maximum extent permitted by law, we shall not be liable for any indirect damages.',
