...
export const LeaderboardSection = () => {
  const getRankBadge = (rank: number) => {
    switch (rank) {
      ...
      default:
        return {
          color: 'bg-gray-700/20 text-gray-400 border-gray-600/30',
          icon: 'user',
        };
    }
  };
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {player.rank <= 3 && (
                    <FontAwesomeIcon
                      icon={rankBadge.icon as IconProp}
                ...
                <div className="flex items-center gap-4 text-xs text-gray-400">
                  <span>
                    Score:{' '}
                    <strong className="text-white">{player.score}</strong>
                  </span>
                  <span>
                    Wins: <strong className="text-white">{player.wins}</strong>
                  </span>
                  <span>
                    Avg:{' '}
                    <strong className="text-white">{player.avgTime}</strong>
                  </span>
                </div>
              </div>
