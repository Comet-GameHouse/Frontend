...
export const BUTTON_VARIANTS: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-r from-blue-500 to-cyan-500 border-blue-600 text-white', // Space blue
...
export const BUTTON_DESIGNS: Record<ButtonDesign, string> = {
  ...
  gradient:
    'border-0 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transition-all',
} as const;
