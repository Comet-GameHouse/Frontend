...
export const UserMenu = () => {
  ...
  return (
    <div className="relative user-menu">
      ...
      <div
        className={`absolute right-0 mt-2 w-48 sm:w-56 bg-gray-800 rounded-xl shadow-2xl border border-gray-700/50 backdrop-blur-lg py-2 z-50 duration-300 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} `}
      >
