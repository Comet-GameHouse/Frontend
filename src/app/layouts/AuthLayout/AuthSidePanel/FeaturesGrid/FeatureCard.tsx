...
export const FeatureCard = ({ feature, index }: FeatureCardProps) => {
  return (
    <div
      className="flex items-start space-x-3 group p-3 rounded-lg hover:bg-blue-500/10 transition-all duration-300 cursor-default"
      data-aos="fade-right"
      data-aos-delay={200 + (index + 1) * 50}
    >
      <div className="w-8 h-8 lg:w-10 lg:h-10 bg-blue-500/20 rounded-lg flex items-center justify-center group-hover:bg-blue-500/30 transition-all duration-300 flex-shrink-0">
        <FontAwesomeIcon
          icon={feature.icon}
